metadata {
	...
	definition (name: "CT101 Thermostat", namespace: "Fuzzy Universe", author: "SmartThings") {
		capability "Actuator"
	...
	tiles {
		...
		main "temperature"
		details(["temperature", "humidity", "battery", "heatSliderControl", "heatingSetpoint", "coolSliderControl", "coolingSetpoint", "mode", "fanMode", "refresh", "configure"])
    	// END CUSTOMIZATION
	}
}
