...
preferences {
    input "inactivityTimeout", "number", title: "Inactivity Timeout:Number of minutes after movement is gone before its reported inactive by the sensor", displayDuringSetup: false, default: 3
...
metadata {
    definition (name:"Linear Motion Sensor", namespace:"Fuzzy Universe", author: "florianz") {
        capability "Battery"
